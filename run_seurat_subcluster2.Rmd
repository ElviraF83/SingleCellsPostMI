...
DotPlot(object = subcluster1, genes.plot = c(plot.genesi), plot.legend = TRUE, x.lab.rot=TRUE)#, col.max =  ("0008ff"))#" scale_colour_gradient2(low = "#ccff00", mid = "#000000", high = "#0008ff") )#+scale_colour_gradient2(low = "#ccff00", mid = "#000000", high = "#0008ff") 
...
#genes<-scan(file="/Users/fortee/Downloads/VivekGenes.xlsx", what="character")
genes<-read.csv("/Users/fortee/Downloads/VivekGenes.csv", header=FALSE)
genes <- unique(genes)
allgenes <- subcluster1@data@Dimnames[1]
  genes1 <- intersect(allgenes, genes)
avg_expr <- AverageExpression(subcluster1, genes.use=genes)
